...
!
      ...
      ICESCALEIN = MAX(0.,MIN(1.,1.-0.5*ICE*ICESCALES(2)))  ! VTC wind input is 50% when ice is 100%
      ICESCALENL = MAX(0.,MIN(1.,1.-ICE*ICESCALES(3)))  ! same for nonlinear; partial reduction
